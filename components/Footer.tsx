        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="space-y-8">
            <div className="flex items-center space-x-3">
              <div className="bg-primary p-2.5 rounded-xl"><i className="fas fa-plane-departure text-white text-xl"></i></div>
              <span className="text-2xl font-black tracking-tighter">CORE <span className="text-primary">AVIATOR</span></span>
            </div>
