            ...
            <div className="bg-white dark:bg-slate-900 p-10 md:p-14 rounded-[4rem] shadow-2xl border border-slate-100 dark:border-slate-800 relative">
              ...
              <form className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                <div className="space-y-3">
                  ...
                  <input type="text" className="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-2xl px-6 py-4 focus:ring-4 focus:ring-primary/20 focus:outline-none dark:text-white" placeholder="John Pilot" />
                </div>
                <div className="space-y-3">
                  <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Email</label>
                  <input type="email" className="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-2xl px-6 py-4 focus:ring-4 focus:ring-primary/20 focus:outline-none dark:text-white" placeholder="wings@sky.com" />
                </div>
                <div className="md:col-span-2 space-y-3">
                  <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Your Aviation Goal</label>
                  <select className="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-2xl px-6 py-4 focus:ring-4 focus:ring-primary/20 focus:outline-none dark:text-white appearance-none">
                ...
                <div className="md:col-span-2 space-y-3">
                  ...
                  <textarea rows={4} className="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-2xl px-6 py-4 focus:ring-4 focus:ring-primary/20 focus:outline-none dark:text-white" placeholder="When would you like to fly?"></textarea>
                </div>
                <div className="md:col-span-2 pt-4">
                  <button type="submit" className="w-full bg-gradient-to-r from-primary to-secondary text-white py-5 rounded-2xl font-black text-lg shadow-xl shadow-primary/30 hover:shadow-primary/50 transition-all active:scale-95">
