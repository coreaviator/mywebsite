          ...
          <div className="hidden lg:flex justify-center items-center relative">
            <div className="relative w-full max-w-md aspect-square">
               ...
               <div className="relative h-full w-full flex flex-col justify-center items-center text-center p-8">
                  <div className="w-32 h-32 bg-white/10 backdrop-blur-xl rounded-[2.5rem] border border-white/20 flex items-center justify-center mb-6 shadow-2xl">
                    <i className="fas fa-plane-departure text-5xl text-primary animate-float"></i>
                  </div>
