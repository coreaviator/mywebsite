          ...
          <div className="space-y-6">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                >
                  <span className={`font-black text-xl md:text-2xl leading-tight transition-colors ${
                    openIdx === i ? 'text-slate-900 dark:text-white' : 'text-slate-600 dark:text-slate-400'
                  }`}>
                    {faq.q}
                  </span>
                  <div className={`flex-shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-500 ${
                    openIdx === i ? 'bg-primary text-white rotate-180 shadow-lg shadow-primary/30' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'
                  }`}>
