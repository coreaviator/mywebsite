...
import cherokee140 from '../assets/cherokee140.jpg';
...
const DiscoveryPage: React.FC = () => {
  ...
  return (
    <div className="animate-fadeIn pb-32">
      {/* Hero Section */}
      {/* Hero Section */}
      <section className="relative py-40 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            alt="Cherokee 140"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-white/60 to-slate-50 dark:from-slate-950/20 dark:via-slate-950/60 dark:to-slate-950"></div>
          {/* Decorative Glow */}
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md px-5 py-2 rounded-full border border-white/20 mb-8">
            ...
            <span className="text-xs font-black tracking-[0.3em] uppercase">Your First Logbook Entry</span>
          </div>
      ...
      <section className="py-24 -mt-16 relative z-20">
        <div className="container mx-auto px-6">
          <div className="bg-white dark:bg-slate-900 p-12 md:p-20 rounded-[4rem] shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-2/3">
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="font-bold dark:text-slate-300 text-lg">No experience required. Just passion.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {journeySteps.map((step, idx) => (
              <div key={idx} className="group relative bg-white dark:bg-slate-900 p-10 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="absolute bottom-6 right-10 text-6xl font-black text-slate-50/50 dark:text-slate-800/20 select-none group-hover:text-primary/10 transition-colors">
                  0{idx + 1}
                </div>
              </div>
            ))}
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900 rounded-[5rem] mx-4 border border-slate-100 dark:border-slate-800">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-black text-slate-900 dark:text-white mb-8 leading-tight">Everything You Need <br /><span className="text-secondary dark:text-primary">To Earn Your Wings.</span></h2>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-slate-800 p-12 rounded-[4rem] shadow-2xl border border-slate-100 dark:border-slate-700 text-center">
                ...
                <div className="text-7xl font-black text-slate-900 dark:text-white mb-6">
                  $150<span className="text-2xl text-slate-400 font-medium">/ flight</span>
                </div>
